...
var WAValidator = isNode
    ? require("../src/wallet_address_validator")
    : window.WAValidator;
...
describe("WAValidator.validate()", function () {
    describe("valid results", function () {
        it("should return true for correct bitcoin addresses", function () {
            ...
            valid("32pAmbg29Dot7vigbqtukpCobJus46FyjZ", "btc");
        ...
        it("should return true for correct BitcoinGold addresses", function () {
            ...
            valid(
                "mvww6DEJ18dbyQUukpVQXvLgrNDJazZn1Y",
                "bitcoingold",
                "testnet"
            );
        ...
        it("should return true for correct Ripple addresses", function () {
            ...
            valid("rJhUaJokmK1JGBZQHWNLv9GiKoj2naQjjF", "XRP");
        });
        ...
        it("should return true for correct Bankex addresses", function () {
            ...
            valid(
                "0xf40d80FCfa5cdEa0bB1E570c2D52132ac9bC6aEC",
                "bankex",
                "testnet"
            );
            valid(
                "0x8A7395f281EeCf2B471B689E87Cf4C7fa8bb957d",
                "BKX",
                "testnet"
            );
        });
        ...
        it("should return true for correct bsv addresses", function () {
            ...
            valid(
                "bitcoincash:qpp32ssez340wfspnt79h6c4xds4fzf3m5j0cplx0l",
                "bsv"
            );
            valid("qqg82u7tq2eahs3gkh9m6kjnmjehr69m5v37alepq4", "bsv");
            valid(
                "bitcoincash:qrwkk9a3es2wu7mdvzh0vekfvjuzysq8tv7r3hcwr5",
                "bsv"
            );
        ...
        it("should return true for correct cro addresses", function () {
            ...
            valid(
                "tcro1mz5rdtf9wufwkh8te2zww7twtmna6rhl2qlhlc",
                "cro",
                "testnet"
            );
            valid(
        ...
        it("should return true for correct monero addresses", function () {
            ...
            valid(
                "5BAP9qLbRseYrGneYVRaFANMajuaD4KZrf3fGWvt5cVDR1xUXm6qoFYLkgU6Vp12fs2R24r4269inAWHFEdsLnE87rGCxYK",
                "XMR",
                "stagenet"
            );
            ...
            valid(
                "5Ls4AeA639AYrGneYVRaFANMajuaD4KZrf3fGWvt5cVDR1xUXm6qoFYLkgU6Vp12fs2R24r4269inAWHFEdsLnE8BCU5Q2gDkbq2HYDrn2",
                "monero",
                "both"
            );
        });
        ...
        it("should return true for correct stellar addresses", function () {
            ...
            valid(
                "GCCVYKDNQP7NGNTR42SYPMQUZIFTPJUJHXM6JIXQMDLXMCC3ZYOV6AG3",
                "xlm",
                "testnet"
            );
        });
        ...
        //Soft launch
        it("should return true for correct alpha addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "alpha");
        });

        it("should return true for correct axs addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "axs");
        });

        it("should return true for correct link addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "link");
        });

        it("should return true for correct matic addresses", function () {
            valid("0x92510530e72cfde0f019da5c8d816a3a6cb660a2", "matic");
        });

        it("should return true for correct sand addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "sand");
        });

        it("should return true for correct sushi addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "sushi");
        });

        it("should return true for correct usdc addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "usdc");
        });

        it("should return true for correct xlm addresses", function () {
            valid(
        ...
        //High
        it("should return true for correct aave addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "aave");
        });

        it("should return true for correct ada addresses", function () {
            valid(
                "DdzFFzCqrht398fnmwFySXhoc4iWeanTNcrLwryVvmu9UT8HzqMtw2n9C5HwrvYLXmxFa1xYq1J3Vn77DEb3XJa7uLJGa8vc3aAD15CN",
                "ada"
            );

            valid(
                "addr1q89gptjepnudpe2pk23yqwlu0656mzqn6sk9wzz79rkju7rs6jxls0ngn2qadghy4h7dterk0gzm3y7czmh8zlsfvmesdasfew",
                "ada"
            );
        });

        it("should return true for correct avax addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "avax");
        });

        it("should return true for correct bch addresses", function () {
            valid(
                "bitcoincash:qry2ev8zhstag9wchp6rs6eyg6us0l84mqxrsypqfq",
                "bch"
            );

            valid("qry2ev8zhstag9wchp6rs6eyg6us0l84mqxrsypqfq", "bch");
        });

        it("should return true for correct bnb addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "bnb");
        });

        it("should return true for correct chz addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "chz");
        });

        it("should return true for correct comp addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "comp");
        });

        it("should return true for correct crv addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "crv");
        });

        it("should return true for correct dai addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "dai");
        });

        it("should return true for correct dot addresses", function () {
            valid("14aGQ997zfrJH4zDrfeAWWkM1xsekqAF9EWQ6CbKQNwC1xVx", "dot");
        });

        it("should return true for correct dydx addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "dydx");
        });

        it("should return true for correct ftm addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "ftm");
        });

        it("should return true for correct knc addresses", function () {
        ...
        //
        it("should return true for correct omg addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "omg");
        });

        it("should return true for correct snx addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "snx");
        });

        it("should return true for correct sol addresses", function () {
            valid("Hp26CCXZJTh8SNQb3nGtqgxz1C5vd8ipeE8KAA8iGgA4", "sol");
        });

        it("should return true for correct uni addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "uni");
        });
        ...
        it("should return true for correct xrp addresses", function () {
            valid("rJhUaJokmK1JGBZQHWNLv9GiKoj2naQjjF", "xrp");
            valid("rpXTzCuXtjiPDFysxq8uNmtZBe9Xo97JbW", "xrp");
        });

        it("should return true for correct yfi addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "yfi");
        });

        it("should return true for correct zrx addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "zrx");
        });
        ...
        it("should return true for correct celo addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "celo");
        });

        it("should return true for correct enj addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "enj");
        });

        it("should return true for correct ens addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "ens");
        });

        it("should return true for correct gala addresses", function () {
            valid("0x76b9bDAE9D2bb93579a1491A0875C1dEe22C110F", "gala");
        });

        it("should return true for correct grt addresses", function () {
    ...
    describe("invalid results", function () {
        function commonTests(currency) {
            ...
            invalid(
                "bd839e4f6fadb293ba580df5dea7814399989983",
                currency,
                "testnet"
            ); //reject transaction id's
        }
        ...
        it("should return false for incorrect bitcoincash addresses", function () {
            ...
            // bch addresses
            invalid(
                "bc1ql08eyrk03qytqc5pdp5fnwpfh0x3y3k2skauvd",
                "bitcoincash",
                "both"
            );
        });
        ...
        it("should return false for incorrect votecoin addresses", function () {
            ...
            invalid(
                "t2YNzUUx8mWBCRYPRezvA363EYXyEpHokyi",
                "votecoin",
                "testnet"
            );
        });
        ...
        it("should return false for incorrect zencash addresses", function () {
            ...
            invalid(
                "ztYWMDLWjbruCJxKmmfAZiT6QAQdiv5F291",
                "zencash",
                "testnet"
            );
        });
        ...
        it("should return false for incorrect nano addresses", function () {
            ...
            invalid(
                "nano_1f5e4w33ndqbkx4bw5jtp13kp5xghebfxcmw9hdt1f7goid1s4373w6tjdgu",
                "nano"
            );
            invalid(
            ...
            invalid(
                "nano_111111111111111111111111111111111111111111111111111hifc8npp",
                "nano"
            );
        });
        ...
        it("should return false for incorrect bsv addresses", function () {
            ...
            invalid(
                "bitcoin:qzpuefrpg3kl2ykQe52rxn96pd3Kp4qudywr5pyrsf",
                "bsv"
            );
...
describe("invalid results", function () {
    ...
    it("should return false for incorrect algo addresses", function () {
        ...
        invalid(
            "LCRDY3LYAANTVS3XRHEHWHGXRTKZYVTX55P5IA2AT5ZDJ4CWZFFZIKVHMJ",
            "algo"
        );
        invalid(
            "SP745JJR4KPRQEXJZHVIEN736LYTL2T2DFMG3OIIFJBV66K73PHNMDCZV",
            "algo"
        );
        invalid(
            "KHSHWO2TUWE53RMVG6ZUBNAEX6MTYPT76TCIDCDWYUUTK6HCJTZS2HDQU",
            "algo"
        );
    });
